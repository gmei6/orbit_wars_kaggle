"""Test v2_macro.physics, including the same-owner co-arrival stacking rule."""
import os, sys
ROOT = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
sys.path.insert(0, ROOT)
from v2_macro import physics as ph
...
def test_resolve_combat_stacking():
    ...
    print("test_v2_macro_physics passed (same-owner co-arrival verified)")
